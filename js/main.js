...
// for_mobile_menu
var bargar = document.getElementByClassName(bargar_btn);
var mobile_menu = document.getElementByClassName(mobile_menu);


bargarid.addEventListener("click", function(){
